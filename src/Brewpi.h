...
#define BREWPI_DISPLAY_NONE			0
#define BREWPI_DISPLAY_CLASSIC		1
#define BREWPI_DISPLAY_SHIFT_LCD	2
#define BREWPI_DISPLAY_OLED			3
#define BREWPI_DISPLAY_TWI_LCD		4 // 20x4 LCD using I2C/TWI
